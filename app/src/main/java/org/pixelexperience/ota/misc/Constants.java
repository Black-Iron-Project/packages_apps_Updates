...
public final class Constants {
    ...
    static final String OTA_URL = "https://raw.githubusercontent.com/Black-Iron-Project/OTA/thirteen/builds/%s.json";
    static final String OTA_CI_URL = "https://raw.githubusercontent.com/Black-Iron-Project/OTA/thirteen/builds/%s.json";
    static final String MAINTAINER_URL = "https://github.com/%s";
    static final String DOWNLOAD_WEBPAGE_URL = "https://raw.githubusercontent.com/Black-Iron-Project/OTA/thirteen/changelogs/%s/%s.txt";
